// GET all Samsung products Query from strapi
...
const SamsungSplitSystems = ({ filterKw }) => {
  const {
...
export const query = graphql`
  {
    allStrapiProduct(
      filter: {sub_categories: {elemMatch: {title: {eq: "samsung"}}}}
      sort: {price: ASC}
    ) {
      nodes {
        id
...
export default SamsungSplitSystems