...
const PAGE_TITLE = "Ipswich Air Conditioning | Supply & Install | Home Comfort Air"
const PAGE_DESC = "Ipswich air conditioning specialists. Supply, installation & servicing of split system, ducted & multi-head air conditioning across Ipswich. Licensed installers, 5-year warranty. 5.0 Stars · 37 Google Reviews."
...
export const Head = () => (
  <Fragment>
    ...
    <Seo
      ...
      url="https://homecomfortair.net.au/ipswich-air-conditioning/"
    />
    <Schema />
...
const suburbs = [
  "Ipswich CBD", "Booval", "Bundamba", "Riverview", "North Ipswich", "East Ipswich",
  "Leichhardt", "Flinders View", "Raceview", "Yamanto", "Brassall", "Karalee",
  "Karana Downs", "Chuwar", "Rosewood", "Goodna", "Redbank", "Redbank Plains",
  "Collingwood Park", "Camira", "Springfield", "Springfield Lakes", "Brookwater", "Ripley",
]

const highlights = [
  {
    value: "18+ Years", label: "Servicing Ipswich",
...
const FAQ_ITEMS = [
  {
    q: "Which Ipswich suburbs do you service?",
    a: "We install and service air conditioning right across Ipswich — from the CBD, Booval and Bundamba through to Springfield, Redbank Plains, Ripley and Rosewood.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes — we supply and install Daikin, Mitsubishi Electric, Samsung, Haier, Midea, Toshiba, Hitachi and Mitsubishi Heavy Industries systems across Ipswich.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Alongside wall-hung split systems, we supply and install ducted air conditioning and multi-head systems for larger Ipswich homes and multi-room comfort.",
  },
  {
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: 16, color: "rgba(255,255,255,0.85)", marginBottom: 32, lineHeight: 1.7, maxWidth: 480 }}>
            We supply and install split system, ducted and multi-head air conditioning for Ipswich homes — from the CBD to the growth corridor suburbs. Licensed installers, backed by a 5-year workmanship warranty.
          </p>
        ...
        <div style={{ borderRadius: 16, overflow: "hidden", boxShadow: "0 24px 48px rgba(0,0,0,0.25)" }}>
          <StaticImage filename="hero-5.jpg" alt="Air conditioning installation in Ipswich by Home Comfort Air" />
        </div>
      </div>
    </section>
    ...
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 24px" }}>
      ...
      <section style={{ marginBottom: 72 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 40 }}>
          <p style={{ fontSize: 17, color: "#374151", lineHeight: 1.85, margin: 0 }}>
            Looking for a reliable air conditioning installer in Ipswich? Our team supplies and installs split system units from top brands including{" "}
          ...
          <p style={{ fontSize: 17, color: "#374151", lineHeight: 1.85, margin: 0 }}>
            Split system air conditioning is a popular choice for Ipswich homes thanks to its efficiency, straightforward installation and versatility. For whole-home comfort, we also supply and install{" "}
      ...
      <section className="how-it-works-section" style={{ marginBottom: 72 }}>
        ...
        <div className="how-it-works-grid">
          <div className="how-step">
            ...
            <p className="how-step-text">Tell us about your space and we'll recommend the right system for your Ipswich home and budget — no obligation.</p>
          </div>
      ...
      {/* ── Products + Quote form ── */}
      <section className="section-2" id="ips-quote" style={{ marginBottom: 72 }}>
        <div className="section-heading">
        ...
        <div className="section-2-grid">
          ...
          <div className="section-2-form">
            <Form title="Ipswich Quote Request" />
          </div>
        </div>
      </section>
      ...
      <section style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <h2 className="section-title" style={{ fontSize: 22, marginBottom: 6 }}>Brands We Install in Ipswich</h2>
      ...
      <section style={{ marginTop: 72, marginBottom: 72 }}>
        ...
        <p style={{ fontSize: 15, color: "#4b5563", lineHeight: 1.8, marginBottom: 24, maxWidth: 720 }}>
          We've been installing split system air conditioning for Ipswich family homes, property managers and builders for over 18 years, covering suburbs including:
        </p>
