...
const PAGE_TITLE = "Brisbane Air Conditioning | Supply & Install | Home Comfort Air"
const PAGE_DESC = "Brisbane air conditioning specialists. Supply, installation & servicing of split system, ducted & multi-head air conditioning across Brisbane. Licensed installers, 5-year warranty. 5.0 Stars · 37 Google Reviews."
...
export const Head = () => (
  <Fragment>
    ...
    <Seo
      ...
      url="https://homecomfortair.net.au/brisbane-air-conditioning/"
    />
    <Schema />
...
const suburbs = [
  "Brisbane CBD", "New Farm", "Ascot", "Clayfield", "Nundah", "Chermside",
  "Aspley", "Carseldine", "Strathpine", "North Lakes", "Redcliffe", "Wynnum",
  "Manly", "Bulimba", "Camp Hill", "Carindale", "Mount Gravatt", "Sunnybank",
  "Sunnybank Hills", "Rochedale", "Springwood", "Forest Lake", "Inala",
  "Toowong", "Paddington", "Indooroopilly", "Kenmore", "Chapel Hill",
]

const highlights = [
  {
    value: "18+ Years", label: "Servicing Brisbane",
...
const FAQ_ITEMS = [
  {
    ...
    a: "We install and service air conditioning right across greater Brisbane — from the CBD and inner north through Chermside and North Lakes, out to the southside via Carindale, Sunnybank and Springwood, and the western suburbs including Toowong and Kenmore.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes — we supply and install Daikin, Mitsubishi Electric, Samsung, Haier, Midea, Toshiba, Hitachi and Mitsubishi Heavy Industries systems across Brisbane.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Alongside wall-hung split systems, we supply and install ducted air conditioning and multi-head systems for larger Brisbane homes and multi-room comfort.",
  },
  {
...
const BrisbanePage = () => (
  <Layout>
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: 16, color: "rgba(255,255,255,0.85)", marginBottom: 32, lineHeight: 1.7, maxWidth: 480 }}>
            We supply and install split system, ducted and multi-head air conditioning for Brisbane homes — from the CBD to the outer suburbs. Licensed installers, backed by a 5-year workmanship warranty.
          </p>
        ...
        <div style={{ borderRadius: 16, overflow: "hidden", boxShadow: "0 24px 48px rgba(0,0,0,0.25)" }}>
          <StaticImage filename="toshiba-mainlg.jpg" alt="Air conditioning installation in Brisbane by Home Comfort Air" />
        </div>
      </div>
    </section>
    ...
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 48, alignItems: "start" }}>
          <div>
            ...
            <p style={{ fontSize: 17, color: "#374151", lineHeight: 1.85, marginBottom: 20 }}>
              Looking for a reputable air conditioning installer in Brisbane? Our team supplies and installs split system units from top brands including{" "}
              <Link to="/products" style={{ color: "#0075C9" }}>Daikin, Mitsubishi Electric, Haier and Midea</Link> — supplied and installed in a single visit, with no middlemen.
            </p>
            <p style={{ fontSize: 17, color: "#374151", lineHeight: 1.85 }}>
              Split system air conditioning is a popular choice for Brisbane homes thanks to its efficiency, straightforward installation and versatility. For whole-home comfort, we also supply and install{" "}
              <Link to="/ducted-systems" style={{ color: "#0075C9" }}>ducted</Link> and{" "}
              <Link to="/multi-head-systems" style={{ color: "#0075C9" }}>multi-head</Link> systems. Every job is backed by our 5-year installation warranty.
            </p>
          </div>

          <div>
            <p style={{ fontSize: 13, fontWeight: 700, color: "#6b7280", marginBottom: 10 }}>Brisbane &amp; Surrounding Areas</p>
      ...
      <section className="how-it-works-section" style={{ marginBottom: 72 }}>
        ...
        <div className="how-it-works-grid">
          <div className="how-step">
            ...
            <p className="how-step-text">Tell us about your space and we'll recommend the right system for your Brisbane home and budget — no obligation.</p>
          </div>
      ...
      {/* ── Products + Quote form ── */}
      <section className="section-2" id="bne-quote" style={{ marginBottom: 72 }}>
        <div className="section-heading">
        ...
        <div className="section-2-grid">
          ...
          <div className="section-2-form">
            <Form title="Brisbane Quote Request" />
          </div>
        </div>
      </section>
      ...
      <section style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <h2 className="section-title" style={{ fontSize: 22, marginBottom: 6 }}>Brands We Install in Brisbane</h2>
      ...
      <section style={{ marginTop: 72, marginBottom: 72 }}>
        ...
        <p style={{ fontSize: 15, color: "#4b5563", lineHeight: 1.8, marginBottom: 24, maxWidth: 720 }}>
          We've been installing split system air conditioning for Brisbane family homes, property managers and builders for over 18 years, covering suburbs including:
        </p>
