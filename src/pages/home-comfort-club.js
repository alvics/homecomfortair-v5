          ...
          <a
            ...
            onClick={() => {
              if (typeof window !== "undefined" && window.gtag) {
                window.gtag("event", "join_club_click", {
          ...
          >
            ...
            <a
              ...
              onClick={() => {
                if (typeof window !== "undefined" && window.gtag) {
                  window.gtag("event", "join_club_click", {
                    link_location: `pricing_card_${plan.name}`,
                  });
                }
              }}
          ...
          <div style={{ position: "relative", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 48, alignItems: "start" }}>
            <div>
              ...
              <a
                ...
                onClick={() => {
                  if (typeof window !== "undefined" && window.gtag) {
                    window.gtag("event", "call_click", { link_location: "inline_contact" });
                  }
                }}
                style={{ display: "inline-flex", alignItems: "center", gap: 8, color: "rgba(255,255,255,0.75)", fontSize: 14, textDecoration: "none", borderTop: "1px solid rgba(255,255,255,0.15)", paddingTop: 16 }}
              >
