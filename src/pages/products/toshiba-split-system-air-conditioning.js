...
const toshibaFeatures = [
  ...
  { title: "5yr Warranty", desc: "Toshiba manufacturer warranty included.", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0075C9" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg> },
]
...
const ToshibaProductsPage = () => {
    ...
    <Layout>
        <div className="body-wrapper ducted-systems p-3">
         ...
         <section>
          ...
          <div className="pb-3">
           ...
           <div> <span className="text-white text-center h3 pb-3" style={{ fontFamily: `'Caveat', cursive` }}>*Quiet, Efficient, and Built to Last – Toshiba</span></div>
        </div>
        </section>
      ...
      <div
              ...
              >
                <h3
                  className="h5 text-white fw-600 mt-2 px-3"
          ...
          <div style={{
            ...
            <div style={{ position: "relative", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 48, alignItems: "start" }}>
              ...
              <div style={{ background: "#fff", borderRadius: 16, padding: "32px 28px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)", maxWidth: 520, marginLeft: "auto" }}>
                <style>{`.toshiba_split_system_air_conditioning .hca-wrapper { background: transparent; box-shadow: none; border: none !important; padding: 0; border-radius: 0 !important; max-width: 100%; }`}</style>
                <div className="toshiba_split_system_air_conditioning"><Form hideTitle /></div>
              </div>
            </div>
          </div>
        </section>
