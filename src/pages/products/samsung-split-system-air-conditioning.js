...
import samsungInstallImg from "../../images/serviceArea/underwood.jpeg"
...
const samsungFeatures = [
  ...
  { title: "High Energy Rating", desc: "Up to 5-star ratings for efficient running costs.", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0075C9" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg> },
  { title: "5–10yr Warranty", desc: "Samsung's manufacturer warranty for peace of mind.", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0075C9" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg> },
]
...
const SamsungSplitSystem = () => (
  <Layout>
    ...
    <section className="full-bleed" style={{
      ...
      <div style={{
        ...
        <div style={{ borderRadius: 16, overflow: "hidden", boxShadow: "0 24px 48px rgba(0,0,0,0.25)" }}>
          <StaticImage filename="brands/Hero/samsung-hero.webp" alt="Samsung split system air conditioner" />
        </div>
      </div>
    </section>

    <BrandPageNav currentBrand="Samsung" />
    ...
    <div className="body-wrapper ducted-systems p-3">
      ...
      <section style={{ borderTop: "1px solid #e8eef5", paddingTop: 40, paddingBottom: 8 }}>
        <div style={{ background: "#0075C9", borderRadius: 10, padding: "18px 24px", marginBottom: 24 }}>
          <h2 style={{ color: "#fff", fontWeight: 700, fontSize: 18, margin: 0 }}>
            Supplied &amp; Installed — Samsung Systems
          </h2>
        </div>
        <SamsungProducts />
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 16 }}>
          <span style={{ fontSize: 14, color: "#6b7280" }}>Samsung brochure</span>
          <a href={SamsungPDF} target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 13, fontWeight: 600, color: "#0075C9", textDecoration: "none", border: "1px solid #e8eef5", borderRadius: 8, padding: "5px 12px" }}>
      ...
      {/* ── Key Features ── */}
      <BrandFeatures features={samsungFeatures} heading="Key Features of Samsung Split Systems" />

      {/* ── Why Choose Section ── */}
      <section style={{ paddingTop: 48, paddingBottom: 48, borderTop: "1px solid #e8eef5" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 40, alignItems: "start" }}>
          <div>
            <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#0075C9", marginBottom: 12 }}>Why Samsung?</p>
            <h2 className="section-title" style={{ fontSize: "clamp(1.4rem, 2.5vw, 1.8rem)", fontWeight: 800, color: "#1f2937", marginBottom: 20, lineHeight: 1.3 }}>
              Smart tech meets efficient comfort
            </h2>
            <p style={{ fontSize: 17, color: "#374151", lineHeight: 1.9, marginBottom: 16 }}>
              Samsung's split systems are designed with Australian living in mind — offering high energy efficiency, whisper-quiet operation, and integrated smart home connectivity. The SmartThings app lets you schedule, monitor, and control your system from anywhere.
            </p>
            <p style={{ fontSize: 17, color: "#374151", lineHeight: 1.9 }}>
              The built-in Auto Clean function dries the heat exchanger after use, preventing mould and keeping air fresh. For whole-home comfort, explore our <Link to="/ducted-systems" style={{ color: "#0075C9" }}>ducted systems</Link> or <Link to="/multi-head-systems" style={{ color: "#0075C9" }}>multi-head options</Link>.
            </p>
          </div>
          <div>
            <div style={{ borderRadius: 12, overflow: "hidden", boxShadow: "0 2px 8px rgba(0,0,0,0.08)", marginBottom: 20, maxWidth: 320 }}>
              <img
                src={samsungInstallImg}
                alt="Samsung outdoor units installed by Home Comfort Air in Underwood"
                style={{ width: "100%", display: "block" }}
              />
              <div style={{ padding: "10px 14px", background: "#f8fafc" }}>
                <div style={{ fontSize: 13, fontWeight: 600, color: "#6b7280" }}>
                  Underwood<span style={{ fontWeight: 500, color: "#9ca3af" }}> · Samsung</span>
                </div>
              </div>
            </div>
        ...
        <div style={{
          ...
          <div style={{ position: "relative", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 48, alignItems: "start" }}>
            ...
            <div style={{ background: "#fff", borderRadius: 16, padding: "32px 28px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)", maxWidth: 520, marginLeft: "auto" }}>
              <style>{`.samsung_form .hca-wrapper { background: transparent; box-shadow: none; border: none !important; padding: 0; border-radius: 0 !important; max-width: 100%; }`}</style>
              <div className="samsung_form"><Form hideTitle /></div>
            </div>
          </div>
        </div>
      </section>
