    ...
    return (
      <Layout>
        <div className="body-wrapper ducted-systems p-3">
          ...
          <div> <span className="text-white text-center h3 pb-3" style={{ fontFamily: `'Caveat', cursive` }}>*Setting the Standard in Air Conditioning</span></div>
        </div>
        </section>
        ...
        <section>
           <div className="ducted-systems-avatar-2 ml-4" style={{textAlign: `center`}}> 
              <StaticImage
                filename="brands/daikin.jpg"
                alt="daikin air conditioning logo"
                
              />
        </div>
        <div style={{marginTop:`-30px`}}><h2 className="h5 fw-600 mt-3">Daikin Air Conditioner</h2></div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 48, alignItems: "start" }}>
              ...
              <div style={{ background: "#fff", borderRadius: 16, padding: "32px 28px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)", maxWidth: 520, marginLeft: "auto" }}>
                <style>{`.daikin_split_system_air_conditioning .hca-wrapper { background: transparent; box-shadow: none; border: none !important; padding: 0; border-radius: 0 !important; max-width: 100%; }`}</style>
                <div className="daikin_split_system_air_conditioning"><Form hideTitle /></div>
              </div>
            </div>
          </div>
        </section>
