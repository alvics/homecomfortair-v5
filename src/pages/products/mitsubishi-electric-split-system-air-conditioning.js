...
export const Head = () => (
  <Fragment>
    ...
    <meta name="description" content="Discover Mitsubishi Electric MSZ-AP series split system air conditioning for your home. Supplied & installed from $1,599 inc GST across Gold Coast, Brisbane & Ipswich." />
    <Seo />
    <Schema />
  </Fragment>
)
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: 22, color: "rgba(255,255,255,0.85)", marginBottom: 40, lineHeight: 1.5, fontFamily: "'Caveat', cursive" }}>
            The Ultimate in Quiet, Efficient Comfort
          </p>
        ...
        <div style={{ borderRadius: 16, overflow: "hidden", boxShadow: "0 24px 48px rgba(0,0,0,0.25)" }}>
          <StaticImage filename="brands/Hero/me-hero.jpg" alt="Mitsubishi Electric split system air conditioner" />
        </div>
      </div>
    </section>
    ...
    <div className="body-wrapper ducted-systems p-3">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 40, alignItems: "center" }}>
          <div>
            <div style={{ maxWidth: 220, marginBottom: 20 }}>
              <StaticImage filename="brands/mitsubishi-electric.jpg" alt="Mitsubishi Electric logo" />
            </div>
            ...
            <p style={{ fontSize: 17, color: "#374151", lineHeight: 1.9, marginBottom: 16 }}>
              Mitsubishi Electric is one of Australia's most trusted air conditioning brands — known for whisper-quiet operation, advanced inverter efficiency, and long-term reliability. The MSZ-AP series is their best-selling residential unit, suited to bedrooms, living rooms, and home offices.
            </p>
      ...
      <section style={{ borderTop: "1px solid #e8eef5", paddingTop: 40, paddingBottom: 8 }}>
        <div style={{ background: "#0075C9", borderRadius: 10, padding: "18px 24px", marginBottom: 24 }}>
          <h2 style={{ color: "#fff", fontWeight: 700, fontSize: 18, margin: 0 }}>
            Supplied &amp; Installed — Mitsubishi Electric Systems
          </h2>
        </div>
        <MitsubishiProducts />
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 16 }}>
          <span style={{ fontSize: 14, color: "#6b7280" }}>Mitsubishi Electric brochure</span>
          <a href={MitsubishiPDF} target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 13, fontWeight: 600, color: "#0075C9", textDecoration: "none", border: "1px solid #e8eef5", borderRadius: 8, padding: "5px 12px" }}>
      ...
      <section style={{ paddingTop: 48, paddingBottom: 48, borderTop: "1px solid #e8eef5" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 40, alignItems: "start" }}>
          <div>
            <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#0075C9", marginBottom: 12 }}>Why Mitsubishi Electric?</p>
            ...
            <p style={{ fontSize: 17, color: "#374151", lineHeight: 1.9, marginBottom: 16 }}>
              Mitsubishi Electric systems are engineered for the demands of the Australian climate — delivering efficient cooling in summer heat and reliable warmth through winter. Their inverter compressors run continuously at the right speed rather than switching on and off, which means consistent comfort and lower power bills.
            </p>
            <p style={{ fontSize: 17, color: "#374151", lineHeight: 1.9 }}>
        ...
        <div style={{
          ...
          <div style={{ position: "relative", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 48, alignItems: "start" }}>
            ...
            <div style={{ background: "#fff", borderRadius: 16, padding: "32px 28px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)", maxWidth: 520, marginLeft: "auto" }}>
              <style>{`.me_form .hca-wrapper { background: transparent; box-shadow: none; border: none !important; padding: 0; border-radius: 0 !important; max-width: 100%; }`}</style>
              <div className="me_form"><Form hideTitle /></div>
            </div>
          </div>
        </div>
      </section>
